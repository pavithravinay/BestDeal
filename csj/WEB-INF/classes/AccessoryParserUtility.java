...
public class AccessoryParserUtility extends DefaultHandler {
    Accessory product;
    // Console console;
    ArrayList<Accessory> products;
    ...
    public AccessoryParserUtility(String productXmlFileName) {
        this.productXmlFileName = productXmlFileName;
        products = new ArrayList<Accessory>();
        
        // prettyPrint();
    }


    public ArrayList<Accessory> parseDocument() {
    ...
    public void endElement(String str1, String str2, String element) throws SAXException {
        ...
        if (element.equalsIgnoreCase("parentProductId")) {
